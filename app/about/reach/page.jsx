...
export default function Reach() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-28 px-6 pb-24 font-sans">
      <div className="max-w-6xl mx-auto">
        
        {/* Header */}
        <div className="mb-20 text-center">
          <h2 className="text-[#38C2D9] text-xs font-black uppercase tracking-[0.5em] mb-4">FIND US</h2>
          <h1 className="mb-6 italic font-black tracking-tighter uppercase text-7xl md:text-8xl">
        ...
        <div className="grid items-stretch gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col space-y-6">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-1">
              {contactInfo.map((info, idx) => (
                <a 
                  ...
                  className="group p-8 bg-[#111] border border-white/5 hover:border-[#38C2D9] transition-all flex items-center gap-6"
                >
                  ...
                  <div>
                    ...
                    <p className="text-lg italic font-bold transition-colors group-hover:text-white">{info.value}</p>
                  </div>
                </a>
              ))}
            </div>
            ...
            {/* Operating Hours Box */}
            <div className="p-8 bg-[#111] border border-white/10 flex-grow">
              ...
              <div className="space-y-4">
                {hours.map((item, idx) => (
                  <div key={idx} className="flex justify-between pb-2 border-b border-white/5">
                    <span className="text-xs font-bold tracking-widest text-gray-400 uppercase">{item.days}</span>
          ...
          <div className="relative min-h-[500px] bg-[#111] border border-white/10 overflow-hidden flex flex-col">
            ...
            <div className="w-full h-1/2 min-h-[250px] relative">
              <iframe 
                ...
                className="absolute inset-0 w-full h-full grayscale invert contrast-[1.2] opacity-70 hover:opacity-100 transition-opacity duration-500"
                style={{ border: 0 }}
                allowFullScreen=""
                loading="lazy"
            ...
            <div className="flex flex-col justify-center flex-1 p-10 bg-black">
              <h3 className="mb-2 text-4xl italic font-black leading-none uppercase">
                Pixoul <span className="text-[#38C2D9]">Hub</span>
              </h3>
              <p className="max-w-xs mb-8 text-sm font-medium tracking-widest text-gray-400 uppercase">
            ...
            {/* Technical Detail */}
            <div className="absolute hidden p-3 border pointer-events-none top-4 right-4 bg-black/60 backdrop-blur-md border-white/5 md:block">
