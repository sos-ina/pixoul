...
function ReviewModal({ onClose }) {
  ...
  <select className="w-full bg-[#111] border border-white/10 rounded-xl p-4 text-sm text-white focus:border-[#38C2D9] outline-none appearance-none cursor-pointer">
    <option className="bg-[#111] text-gray-400">Select an experience...</option>
    <option className="bg-[#111] text-white" value="vr">VR Games</option>
    <option className="bg-[#111] text-white" value="pc">PC Arena</option>
    <option className="bg-[#111] text-white" value="retro">Retro Zone</option>
  </select>
</div>
          ...
          <div className="flex gap-4 pt-2">
            <button className="flex-1 py-4 bg-[#38C2D9] text-black font-black rounded-xl italic uppercase hover:scale-[1.02] transition-transform">
              Publish Review
            </button>
