    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-black dark:text-white pt-28 px-6 pb-24">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-24 text-center">
          ...
          <h1 className="mb-6 font-black tracking-tighter uppercase text-3xl sm:text-5xl md:text-7xl">
            Our <span className="text-[#38C2D9]">Story</span>
          </h1>
          <p className="max-w-2xl mx-auto text-lg font-medium leading-relaxed text-black/60 dark:text-white/70">
        ...
        <div className="grid items-center gap-12 mb-32 md:grid-cols-2">
          <div className="p-10 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-none">
            <h3 className="mb-6 text-2xl italic font-black uppercase">Where It All Began</h3>
            <p className="mb-4 text-sm leading-relaxed text-black/60 dark:text-white/70">
        ...
        <div className="relative pl-6 sm:pl-10 ml-4 sm:ml-0 space-y-16 border-l-2 border-black/10 dark:border-white/10 md:ml-0">
          <h3 className="text-4xl font-black uppercase mb-12 ml-[-2.5rem] bg-white dark:bg-[#0a0a0a] inline-block pr-4">
          ...
          {timeline.map((item, idx) => (
            <div key={idx} className="relative group">
              {/* Timeline Dot */}
              <div className="absolute -left-[3.15rem] top-1 w-4 h-4 rounded-full bg-white dark:bg-[#111] border-2 border-black/30 dark:border-white/20 group-hover:border-[#38C2D9] transition-colors"></div>
              ...
              <div className="flex flex-col gap-2 md:flex-row md:items-baseline md:gap-8">
                ...
                <div>
                  ...
                  <p className="max-w-xl text-sm leading-relaxed text-black/60 dark:text-white/70">{item.desc}</p>
                </div>
              </div>
            </div>
          ))}
