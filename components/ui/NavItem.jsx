...
export default function NavItem({
  ...
  const wrapperClass = "relative text-white hover:text-[#38C2D9] cursor-pointer transition-colors text-sm lg:text-sm xl:text-base whitespace-nowrap flex items-center gap-1 py-2 text-black dark:text-white dark:hover:text-[#38C2D9]";
